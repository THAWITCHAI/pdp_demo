                ...
                <div class="w-full h-fit p-3">
                    ...
                    <form method="GET" class="w-full p-2 ring-1 ring-gray-300 my-5 flex flex-col justify-center items-center gap-2">
                        ...
                        <div class="w-full flex gap-10 justify-center items-center p-2">
                            ...
                            <input name="sex" placeholder="Lab Name " type="text" class="border border-gray-300 text-sm   h-[2rem] outline-none px-2 rounede-xs  w-full">
                        ...
                        <table class="min-w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                    <tr class="bg-white border-b border-gray-200">
                                        ...
                                        <td class="px-1 py-4 border border-gray-300"></td>
                                        <td class="px-1 py-4 border border-gray-300"></td>
                                        <td class="px-1 py-4 border border-gray-300 text-center">1</td>
